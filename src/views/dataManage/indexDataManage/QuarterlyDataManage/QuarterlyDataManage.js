...
class QuarterlyDataManage extends  Component {
    ...
    render() {
        ...
        return (
            <Layout.Col span={18}>
                <div className="QuaDataManage">
                    <h3>季度数据管理</h3>
                    <div>
                        <span>关键字查询</span>
                        <Select value={this.state.value} onChange={e => this.handleOption(e,"Select1")} className="QuaDataManage_Select" placeholder="农业状况" clearable={true}>
                            {
                        ...
                        <span>年度</span>
                        <Select value={this.state.value} className="QuaDataManage_Select" placeholder="----" clearable={true} onChange={e => this.handleOption(e,"Select2")}>
                            {
                        ...
                        <span>月份</span>
                        <Select value={this.state.value} className="QuaDataManage_Select" placeholder="--" clearable={true} onChange={e => this.handleOption(e,"Select3")}>
                            {
                        ...
                        <span>数据项</span>
                        <Select value={this.state.value} className="QuaDataManage_Select" placeholder="当期数据" clearable={true} onChange={e => this.handleOption(e,"Select4")}>
                            {
...
export default QuarterlyDataManage