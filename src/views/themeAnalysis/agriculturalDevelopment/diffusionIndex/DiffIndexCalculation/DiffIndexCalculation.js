...
class DiffIndexCalculation extends  Component{
    ...
    handleClickForCalculate(){
        this.$post('/DICalculate/calculate',this.state.settings)
             .then(res=>{
                if(res != null){
                    alert('计算成功！结算结果已显示在"扩散指数查看"页面的最新一条');
                    window.location.href="/themeAnalysis/agriculturalDevelopment/syntheticIndex/SynIndexView#/themeAnalysis/agriculturalDevelopment/diffusionIndex/DiffIndexView";
                }
            }).catch(e=>{
            console.log(e)
        })
        ...
        return(
            ...
            <div className="DiffIndexCal">
                <div>
                    ...
                    <div id="page1">
                        <Layout.Row>
                        <div className="DiffIndexCal-heading">当前指标组合:</div>
                        </Layout.Row>
                        <Layout.Row>
                            <Table
                                columns={columns}
                    ...
                    <div id="page2">
                        <div id="editname1">
                                <Layout.Row>
                                <div className="DiffIndexCal-heading">指标组合：{this.state.combination}</div>
                                <Layout.Row>
                        ...
                        <div id="editname2">
                            <Layout.Row>
                            <span><div className="DiffIndexCal-heading">指标组合：</div></span>
                    ...
                    <hr/>
                    <Layout.Row>
                    <div className="DiffIndexCal_button text-center">
